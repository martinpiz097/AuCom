...
import cl.estencia.labs.aucom.common.ListUtil;
...
public class AudioHardware {
    ...
    public List<Mixer> getMixers() {
        return ListUtil.streamOf(AudioSystem.getMixerInfo())
                .map(AudioSystem::getMixer)
                .collect(Collectors.toCollection(
                        ListUtil::newLinkedList));
    }
    ...
    public List<Control> getAllControls(Line line) throws LineUnavailableException {
        final List<Control> listControls = ListUtil.newLinkedList();
        boolean opened;
        if (!line.isOpen()) {
            line.open();
            opened = true;
    ...
    public List<DataLine.Info> getAllSpeakerInfo() {
        final List<DataLine.Info> listInfo = ListUtil.newLinkedList();
    ...
    public float getFormattedMasterVolume() {
        ...
        return volumeConverter.dataLineVolumeToVolume(volumeControl.getValue(), volumeControl);
    }
    ...
    private static List<Line> getAvailableLines(Mixer mixer, Line.Info[] lineInfos) {
        final List<Line> lines = ListUtil.newLinkedList();
        Line.Info lineInfo;
        Line line;
